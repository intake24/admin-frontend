...
angular.module('intake24.admin.food_db').controller('AssociatedFoodModalController', ['$scope', 'FoodDataReader', 'Drawers', function ($scope, FoodDataReaderService, drawers) {
